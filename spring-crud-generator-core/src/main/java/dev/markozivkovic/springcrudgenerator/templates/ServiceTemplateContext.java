...
public class ServiceTemplateContext {
    ...
    /**
     * Creates a template context for the bulk delete method of a model.
     *
     * @param modelDefinition the model definition
     * @return a template context for the bulk delete method
     */
    public static Map<String, Object> computeBulkDeleteContext(final ModelDefinition modelDefinition) {
