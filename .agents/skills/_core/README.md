...
Three shared files that the thirteen skills link to instead of duplicating.
...
| [`ROUTING.md`](ROUTING.md) | Which skills a change loads, for implementation and review alike | **Authoritative for loading.** Every skill links it; no skill keeps its own copy of the table |
...
None of them replaces reading the owner skill before implementing something it covers. `RULES.md`
