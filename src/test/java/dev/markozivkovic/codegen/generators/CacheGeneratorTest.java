...
class CacheGeneratorTest {
    ...
    void generate_shouldSkipWhenCacheIsNull() {
        ...
        final CacheGenerator generator = new CacheGenerator(crudConfig, packageConfiguration);
    ...
    void generate_shouldSkipWhenCacheDisabled() {
        ...
        final CacheGenerator generator = new CacheGenerator(cc.crudConfig, packageConfiguration);
    ...
    void generate_shouldSkipWhenAlreadyGeneratedInContext() {
        ...
        try (final MockedStatic<GeneratorContext> genCtx = mockStatic(GeneratorContext.class);
            ...
            genCtx.when(() -> GeneratorContext.isGenerated(GeneratorConstants.GeneratorContextKeys.CACHE_CONFIGURATION))
                    .thenReturn(true);
    ...
    void generate_shouldGenerateCacheConfigurationWithExplicitValues() {
        ...
        try (final MockedStatic<GeneratorContext> genCtx = mockStatic(GeneratorContext.class);
            ...
            pkg.when(() -> PackageUtils.computeConfigurationPackage("com.example.app", packageConfiguration))
                    .thenReturn("com.example.app.config");
            pkg.when(() -> PackageUtils.computeConfigurationSubPackage(packageConfiguration))
                    .thenReturn("config");
    ...
    @Test
    void generate_shouldUseDefaultCacheTypeSimpleWhenTypeIsNull() {
